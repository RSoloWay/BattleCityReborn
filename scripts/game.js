...
class Menu extends Phaser.Scene{
    ...
    preload(){
        ...
        this.load.audio('theme', 'assets/audio/levelstarting.mp3');
        this.load.audio('moving', 'assets/audio/moving.mp3');
        this.load.audio('nmoving', 'assets/audio/nmoving.mp3');
        this.load.audio('shoot', 'assets/audio/shoot.mp3');
        this.load.audio('brickhit', 'assets/audio/brickhit.mp3');
        this.load.audio('steelhit', 'assets/audio/steelhit.mp3');
        this.load.audio('explode', 'assets/audio/fexplosion.mp3');
        this.load.audio('enemy_explode', 'assets/audio/eexplosion.mp3');
    }
